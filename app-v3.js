...
/* ============================================================
   ...
   Design tokens:
   - bg-base   #0D1117  (asphalt)
   - bg-surface #161D26 (panel)
   - bg-raised #1A2430  (card)
   - line     #26313D
   - text-hi  #ECEFF3
   - text-lo  #8A94A2
...
function Pill({
  ...
  return /*#__PURE__*/React.createElement("button", {
    ...
    style: {
      padding: "7px 13px",
      borderRadius: 999,
      border: `1px solid ${active ? c : "#26313D"}`,
      background: active ? `${c}1A` : "transparent",
      color: active ? c : "#8A94A2",
      fontSize: 13,
      fontWeight: 600,
      whiteSpace: "nowrap",
      cursor: "pointer",
...
function DirectionOption({
  ...
  return /*#__PURE__*/React.createElement("button", {
    ...
    style: {
      ...
      padding: "12px 14px",
      borderRadius: 12,
      border: `1px solid ${active ? "#5B7A93" : "#26313D"}`,
      background: active ? "#5B7A931A" : "#0D1117",
      cursor: "pointer",
      color: "#ECEFF3"
    }
...
function NoteRow({
  ...
  return /*#__PURE__*/React.createElement(Card, {
    style: {
      ...
      borderColor: urgency !== "none" && urgency !== "later" ? `${ustyle.color}55` : "#1F2A35"
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
