...
/* ============================================================
   ...
   Design tokens:
   - bg-base   #F4F1EA  (asphalt)
   - bg-surface #FFFFFF (panel)
   - bg-raised #E3DDCC  (card)
   - line     #DAD3C0
   - text-hi  #23262B
   - text-lo  #746C5E
...
function Pill({
  ...
  return /*#__PURE__*/React.createElement("button", {
    ...
    style: {
      padding: "7px 13px",
      borderRadius: 999,
      border: `1px solid ${active ? c : "#DAD3C0"}`,
      background: active ? `${c}1A` : "transparent",
      color: active ? c : "#746C5E",
      fontSize: 13,
      fontWeight: 600,
      whiteSpace: "nowrap",
      cursor: "pointer",
...
function LoginScreen({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      height: 12,
      borderRadius: 3,
      background: `linear-gradient(135deg, ${COMPANY_COLORS.AMCARS} 50%, ${COMPANY_COLORS.MELBUS} 50%)`,
  ...
  return /*#__PURE__*/React.createElement("div", {
    style: shellStyle
        ...
        * { box-sizing: border-box; }
        ...
        input::placeholder { color: #8F8674; }
...
const shellStyle = {
  ...
  background: `
    ...
    radial-gradient(1100px 550px at 15% -8%, #DFF3EE 0%, transparent 55%),
    radial-gradient(1100px 550px at 100% 0%, #FCEFD9 0%, transparent 50%),
    radial-gradient(1200px 700px at 50% -10%, #FFFFFF 0%, #F4F1EA 55%, #EDE9DC 100%)
  `,
  color: "#23262B",
  fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",
  display: "flex",
...
function BottomNav({
  ...
  return /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      maxWidth: 480,
      width: "100%",
      background: "linear-gradient(0deg, #EDE9DC 40%, #F4F1EA00 100%)",
      pointerEvents: "none"
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
...
function TxRow({
  ...
  return /*#__PURE__*/React.createElement(Card, {
    ...
    style: {
      fontSize: 10,
      fontWeight: 700,
      color: COMPANY_COLORS[tx.company] || "#E8A33D",
      border: `1px solid ${COMPANY_COLORS[tx.company] || "#E8A33D"}55`,
      borderRadius: 6,
      padding: "1px 5px"
    }
...
function DirectionOption({
  ...
  return /*#__PURE__*/React.createElement("button", {
    ...
    style: {
      ...
      padding: "12px 14px",
      borderRadius: 12,
      border: `1px solid ${active ? "#5B7A93" : "#DAD3C0"}`,
      background: active ? "#46647C1A" : "#F4F1EA",
      cursor: "pointer",
      color: "#23262B"
    }
    ...
    style: {
      ...
      height: 18,
      borderRadius: "50%",
      border: `2px solid ${active ? "#5B7A93" : "#C9C0AE"}`,
...
function Dashboard({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    size: "sm2",
    colorOverride: (balance.cards[c] || 0) < 0 ? "#C1553B" : COMPANY_COLORS[c]
...
function NoteRow({
  ...
  return /*#__PURE__*/React.createElement(Card, {
    style: {
      ...
      borderColor: urgency !== "none" && urgency !== "later" ? `${ustyle.color}55` : "#E3DDCC"
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
