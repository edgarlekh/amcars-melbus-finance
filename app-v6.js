...
/* ============================================================
   ...
   Design tokens:
   - bg-base   #0B0B14  (asphalt)
   - bg-surface #15151F (panel)
   - bg-raised #242435  (card)
   - line     #2E2E42
   - text-hi  #F3F1FA
   - text-lo  #A9A3BE
   - amber    #FFC857   (signature accent — road marking)
   - green    #34D399   (income)
   - rust     #FB5D5D   (expense)
   - steel    #A78BFA   (transfer / neutral)
...
function Pill({
  ...
  return /*#__PURE__*/React.createElement("button", {
    ...
    style: {
      padding: "7px 13px",
      borderRadius: 999,
      border: `1px solid ${active ? c : "#2E2E42"}`,
      background: active ? `${c}1A` : "transparent",
      color: active ? c : "#A9A3BE",
      fontSize: 13,
      fontWeight: 600,
      whiteSpace: "nowrap",
      cursor: "pointer",
...
function Card({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: className,
    style: {
      background: "linear-gradient(165deg, #1C1C2ecc 0%, #14141Fcc 100%)",
      backdropFilter: "blur(16px)",
      WebkitBackdropFilter: "blur(16px)",
      border: "1px solid #3D3D58",
      boxShadow: "inset 0 1px 0 #FFFFFF0D, 0 4px 18px #00000040",
...
function LoginScreen({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      height: 12,
      borderRadius: 3,
      background: `linear-gradient(135deg, ${COMPANY_COLORS.AMCARS} 0%, #A78BFA 50%, ${COMPANY_COLORS.MELBUS} 100%)`,
  ...
  if (status === "loading" || !state) {
    return /*#__PURE__*/React.createElement("div", {
      style: {
        ...
        maxWidth: 480,
        margin: "0 auto",
        background: "linear-gradient(180deg, #0A0A12 0%, #06060B 100%)",
        display: "flex",
  ...
  return /*#__PURE__*/React.createElement("div", {
    style: shellStyle
        ...
        * { box-sizing: border-box; }
        ...
        input::placeholder { color: #7C7690; }
...
const shellStyle = {
  minHeight: "100vh",
  background: `
    radial-gradient(650px 500px at 8% 0%, #22D3EE33 0%, transparent 60%),
    radial-gradient(700px 550px at 100% 10%, #FF6B4A2E 0%, transparent 55%),
    radial-gradient(900px 700px at 50% 100%, #7C4DFF22 0%, transparent 60%),
    linear-gradient(180deg, #0A0A12 0%, #06060B 100%)
  `,
  color: "#F3F1FA",
  fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",
  display: "flex",
...
function Header({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      fontSize: 10.5,
      fontWeight: 600,
      color: saveError ? "#FB5D5D" : saving ? "#FFC857" : "#34D399"
    }
...
function BottomNav({
  ...
  return /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      maxWidth: 480,
      width: "100%",
      background: "linear-gradient(0deg, #06060B 40%, #06060B00 100%)",
      pointerEvents: "none"
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      style: {
        flex: 1,
        background: active ? "#FFC85718" : "none",
        border: "none",
        borderRadius: 15,
        padding: "8px 0 7px",
        color: active ? "#FFC857" : "#7C7690",
        display: "flex",
        flexDirection: "column",
        alignItems: "center",
        gap: 2,
...
function ReceiptScanForm({
  ...
  return /*#__PURE__*/React.createElement(Sheet, {
    ...
    style: primaryBtnStyle
  }, "Далее")), stage === "pick" && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      color: "#A9A3BE",
      marginBottom: 14
    }
  }, "Загрузите скриншот банковской выписки счёта ", /*#__PURE__*/React.createElement("b", null, company), " — операции распознаются автоматически, вы сможете проверить и поправить их перед сохранением."), /*#__PURE__*/React.createElement("label", {
...
function TxRow({
  ...
  return /*#__PURE__*/React.createElement(Card, {
    ...
    style: {
      fontSize: 10,
      fontWeight: 700,
      color: COMPANY_COLORS[tx.company] || "#FFC857",
      border: `1px solid ${COMPANY_COLORS[tx.company] || "#FFC857"}55`,
      borderRadius: 6,
      padding: "1px 5px"
    }
...
function DirectionOption({
  ...
  return /*#__PURE__*/React.createElement("button", {
    ...
    style: {
      ...
      padding: "12px 14px",
      borderRadius: 12,
      border: `1px solid ${active ? "#A78BFA" : "#2E2E42"}`,
      background: active ? "#A78BFA1A" : "#0B0B14",
      cursor: "pointer",
      color: "#F3F1FA"
    }
    ...
    style: {
      ...
      height: 18,
      borderRadius: "50%",
      border: `2px solid ${active ? "#A78BFA" : "#4A4A5E"}`,
...
function SplitCard({
  ...
  return /*#__PURE__*/React.createElement(Card, null, /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      fontSize: 10,
      fontWeight: 700,
      color: COMPANY_COLORS[split.company] || "#FFC857",
      border: `1px solid ${COMPANY_COLORS[split.company] || "#FFC857"}55`,
      borderRadius: 6,
      padding: "1px 5px"
    }
...
function ChangeBadge({
  ...
  const color = pct === 0 ? "#A78BFA" : isGood ? "#34D399" : "#FB5D5D";
...
function NoteRow({
  ...
  return /*#__PURE__*/React.createElement(Card, {
    style: {
      ...
      borderColor: urgency !== "none" && urgency !== "later" ? `${ustyle.color}55` : "#2A2A3D"
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
...
const fabStyle = {
  ...
  height: 56,
  borderRadius: 18,
  background: "linear-gradient(135deg, #22D3EE 0%, #A78BFA 50%, #FF6B4A 100%)",
  color: "#0B0B14",
  fontSize: 28,
  fontWeight: 800,
  border: "none",
  boxShadow: "0 8px 28px #A78BFA55, 0 4px 14px #00000070",
  cursor: "pointer",
  lineHeight: "56px",
  zIndex: 20
};
